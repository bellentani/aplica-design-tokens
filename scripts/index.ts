    ...
    const valor = {
      palette: {
        surface: {
          ...
          110: { type: 'color', value: colorLighten[10] },
          120: { type: 'color', value: colorLighten[20] },
          130: { type: 'color', value: colorLighten[30] },
          140: { type: 'color', value: colorLighten[40] },
          150: { type: 'color', value: colorLighten[50] },
          160: { type: 'color', value: colorLighten[60] },
          170: { type: 'color', value: colorLighten[70] },
          180: { type: 'color', value: colorLighten[80] },
          190: { type: 'color', value: colorLighten[90] },
        },
        txtOn: {
      ...
      behavior: {
        surface: {
          darkest: { type: 'color', value: colorLighten[80] },
          action: { type: 'color', value: colorLighten[30] },
